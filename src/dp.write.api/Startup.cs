...
using dp.write.api.Filters;
using dp.write.api.Security;
using System.Text.Json.Serialization;
using System.Text.Json;
using System.Linq;
using System.Reflection;
//using dp.write.api.Enums;
...
namespace dp.write.api
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    {
                        Version = "v1",
                        Title = "Doge Protocol Write API",
                        Description = "Doge Protocol Write API"
                    });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "DogeProtocolWriteAPI v1");
            });
        }
    }
}
